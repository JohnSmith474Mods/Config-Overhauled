...
public class ARGBColorEntry extends ColorEntry<Property<Integer>> {
    public ARGBColorEntry(Property<Integer> property, ConfigScreen parentScreen, Minecraft minecraft, Runnable onValueChanged) {
    ...
    protected FormattedCharSequence formatColorString(String text, int cursorOffset) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            else if (absoluteIndex == 1 || absoluteIndex == 2) color = 0xFFFFFFFF;
            else if (absoluteIndex == 3 || absoluteIndex == 4) color = 0xFFFF5555;
            else if (absoluteIndex == 5 || absoluteIndex == 6) color = 0xFF55FF55;
            else if (absoluteIndex == 7 || absoluteIndex == 8) color = 0xFF5555FF;
