...
public class FabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> {
            dispatcher.register(ClientCommands.literal(Constants.CONFIG_DUMP)
                    .then(ClientCommands.argument(Constants.NAMESPACE, StringArgumentType.word())
            ...
            dispatcher.register(ClientCommands.literal(Constants.CONFIG_LANG_GEN)
                    .then(ClientCommands.argument(Constants.NAMESPACE, StringArgumentType.word())
                            .suggests(AbstractDataGenCommand::suggestModIds)
                            .executes(context -> {
                                String modId = StringArgumentType.getString(context, Constants.NAMESPACE);
